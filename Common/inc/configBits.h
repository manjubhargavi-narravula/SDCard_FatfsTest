...
//
// SUMMARY:
// This header includes the configuration register settings for all O2 firmware.  It must be
// included in each O2 FW project.
//
// REVISION HISTORY:
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// M. Marrama          DEC/04/2013   Configure Watchdog Timer
// M. Marrama          MAY/05/2014   Change oscillator source from XT to EC
// K. Jin              FEB/21/2023   Migrated to #pragma config
//
//**************************************************************************************************
...
#pragma config POSCMD = XT             // Primary Oscillator Source (EC Oscillator Mode)
